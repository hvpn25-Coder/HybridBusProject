...
| REQ-DAT-001 | Data | Route geometry, display elevation, and time histories shall be ordered, finite, and traceable. | 3.2 | Route / Route_Geometry / Elevation_m | RouteGeolocation; RouteValidationFailure | Valid coordinate/elevation bounds, provenance, and strictly ordered sequence | PASS |
