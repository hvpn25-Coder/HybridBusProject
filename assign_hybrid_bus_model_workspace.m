...
if isfield(Input.Mass,'TotalVehicleMass_kg')
    ...
    mass=Input.Mass.CurbMass_kg+Input.Mass.PassengerCount*Input.Mass.PassengerMass_kg+ ...
        Input.Mass.CargoMass_kg+B1.Mass_kg+B2.Mass_kg+2*M.Mass_kg+ ...
        Input.Genset.Mass_kg+2*F.Mass_kg;
end
variables=struct;
...
variables.motor_regen_limit_kw=min(2*M.PeakPower_kW*F.RegenEfficiency, ...
    min(B1.MaxRegen_kW,B2.MaxRegen_kW));
