...
Input.Battery1 = select_row(Database.Battery_Catalog,Input.SelectedIDs.Battery1);
Input.Battery2 = select_row(Database.Battery_Catalog,Input.SelectedIDs.Battery2);
