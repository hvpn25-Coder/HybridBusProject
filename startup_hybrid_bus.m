...
folders = {rootFolder, fullfile(rootFolder, 'tests'), ...
    fullfile(rootFolder, 'documentation')};
...
if ~isfile(fullfile(rootFolder, 'HybridBus_ComponentDatabase.xlsx'))
    create_default_database(fullfile(rootFolder, 'HybridBus_ComponentDatabase.xlsx'));
end
